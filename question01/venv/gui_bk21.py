...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.encode.grid(column=0, row=3, padx=8, sticky=W)
        self.decode.grid(column=0, row=4, padx=8, sticky=W)
        ...
        ttk.Separator(self,
                      orient=HORIZONTAL
                      ).grid(row=8, column=0, columnspan=3, sticky=NSEW, pady=5, padx=5)
    ...
    def processSelections(self):
        ...
        if self.codeValue.get() == 'E':
            ...
            self.decoded_message = decode(self.fileName)
            self.msg2show.set("Decoded Message: " + self.decoded_message)
